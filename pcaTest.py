...
pca_data1 = computePCA(48, dp.TrainData1_normalized.append(dp.TestData1_normalized,ignore_index=True))
...
#the pca is a new mapping for the features
pca_data2 = computePCA(200, dp.TrainData2_normalized.append(dp.TestData2_normalized,ignore_index=True))
...
#the pca is a new mapping for the features
pca_data3 = computePCA(170, dp.TrainData3_normalized.append(dp.TestData3_normalized,ignore_index=True))
